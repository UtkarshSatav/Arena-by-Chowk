            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                    <FadeIn delay={0.2} direction="right" fullWidth>
                        <div
                            className="glass-card rounded-sm p-10 h-full"
                        ...
                        >
                            ...
                            <p
                                ...
                                style={{ color: "rgba(var(--glass-rgb),0.55)" }}
                            >
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        {[
                            ...
                            <FadeIn key={i} delay={0.2 + (0.1 * i)} direction="up" fullWidth>
                                <div
                                    className="glass-card feature-card rounded-sm p-6 flex flex-col items-center text-center h-full"
                                ...
                                >
                                    ...
                                    <p className="text-[10px]" style={{ color: "rgba(var(--glass-rgb),0.4)" }}>
                                        {item.desc}
                                    </p>
                                </div>
                            </FadeIn>
                ...
                <FadeIn delay={0.6} direction="up" fullWidth>
                    <div
                        ...
                        style={{ background: `linear-gradient(135deg, rgba(255,184,0,0.06) 0%, rgba(var(--inverse-glass-rgb),0) 100%)`, border: "1px solid rgba(255,184,0,0.15)" }}
                    >
